(async () => {
    ...
    const message = {
      ...
      message: `
            <div style="text-align: left; padding: 0px;">
              ...
              <br>
              <p>We appreciate your patience. If you have any questions or need to check the status of your review, feel free to email us at support@sunbet.co.bw</p>
            </div>
          `,
    };
  ...
  if (!idStatus) {
    ...
    <div style="text-align: left; padding: 0px;">
      ...
      <br>
      <p>If you've already submitted your documents you can email support@sunbet.co.bw to check the status of your account.</p>
    </div>
          `,
      action: {
        type: "modal",
  ...
  if (!validIdentityStates.includes(idStatus)) {
    ...
    <div style="text-align: left; padding: 0px;">
      ...
      <p>Submitting your FICA documents is as easy as 1,2,3.</p>
      <br>
      <p>If you've already correctly submitted your documents you can email support@sunbet.co.bw to check the status of your account.</p>
    </div>
          `,
      action: {
        type: "modal",
