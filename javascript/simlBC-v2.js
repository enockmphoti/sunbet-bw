function SimlBedeClient(e) {
  ...
  return (
    ...
    (this.register = function (e, t) {
      ...
      e.currencyCode || (e.currencyCode = 'BWP'),
    ...
    (this.requestWithdrawal = function (e, t) {
      ...
      e.currency_code || (e.currency_code = 'BWP'),
    ...
    (this.getMyZakaHistory = function (e, t) {
      var n;
      b(
        r.config.bede_site_code,
        'GET',
        r.config.session_path + '/myzaka/listDepositStatus?take=20&skip=' + e,
        '',
        !1,
        !0,
        function (e, n) {
    ...
    (this.ottCreate = function (e, n) {
      var i,
        s = JSON.stringify({ voucher: e});
      b(
        r.config.bede_site_code,
        'POST',
    ...
    (this.getWithdrawalEntities = function (callback) {
    var reqBody = '';
    b(
      r.config.bede_site_code,
      'POST',
      r.config.session_path + '/listwithdrawalentities',
      reqBody,
      false,
      true,
    ...
    (this.myZakaDeposit = function(e,t){
            var n,
        i = JSON.stringify({ amount: e });
      b(
        r.config.bede_site_code,
        'POST',
        r.config.session_path + '/myzaka/Deposit',
        i,
        !1,
        !0,
        function (e, n) {
      ...
      (this.orangeDeposit = function(e,l,t){
      var n,
        i = JSON.stringify({ amount: e, mobile: l});
      b(
        r.config.bede_site_code,
        'POST',
        r.config.ingress_session_path + '/orange/deposit/generate',
        i,
        !1,
        !0,
        function (e, n) {
      ...
      (this.orangeCheck = function(e,t){
      var n,
        i = JSON.stringify({ reference: e});
      b(
        r.config.bede_site_code,
        'POST',
        r.config.ingress_session_path + '/orange/deposit/check',
        i,
        !1,
        !0,
        function (e, n) {
